...
pub mod kv_store_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn set(
            ...
            req.extensions_mut().insert(GrpcMethod::new("kv_store.KVStore", "Set"));
        ...
        pub async fn get(
            ...
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("kv_store.KVStore", "Get"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn delete(
            &mut self,
            ...
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("kv_store.KVStore", "Delete"));
            self.inner.unary(req, path, codec).await
        }
    }
}
