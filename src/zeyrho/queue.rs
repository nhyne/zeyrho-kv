...
pub struct DequeueResponse {
    ...
    pub messages: ::prost::alloc::vec::Vec<dequeue_response::QueueMessage>,
}
/// Nested message and enum types in `DequeueResponse`.
pub mod dequeue_response {
    #[derive(serde::Serialize, serde::Deserialize, Clone, PartialEq, ::prost::Message)]
...
pub mod queue_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn enqueue(
            ...
            let path = http::uri::PathAndQuery::from_static("/queue.Queue/Enqueue");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("queue.Queue", "Enqueue"));
        ...
        pub async fn dequeue(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/queue.Queue/Dequeue");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("queue.Queue", "Dequeue"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn size(
            &mut self,
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/queue.Queue/Size");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("queue.Queue", "Size"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn replicate_data(
            &mut self,
            request: impl tonic::IntoStreamingRequest<Message = super::ReplicateDataRequest>,
        ) -> std::result::Result<
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/queue.Queue/ReplicateData");
            let mut req = request.into_streaming_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("queue.Queue", "ReplicateData"));
...
pub mod queue_server {
    ...
    pub trait Queue: std::marker::Send + std::marker::Sync + 'static {
        ...
        ) -> std::result::Result<tonic::Response<Self::ReplicateDataStream>, tonic::Status>;
    }
    #[derive(Debug)]
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/queue.Queue/Enqueue" => {
                    ...
                    impl<T: Queue> tonic::server::UnaryService<super::EnqueueRequest> for EnqueueSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move { <T as Queue>::enqueue(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
                ...
                "/queue.Queue/Dequeue" => {
                    ...
                    impl<T: Queue> tonic::server::UnaryService<super::DequeueRequest> for DequeueSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move { <T as Queue>::dequeue(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
                    let accept_compression_encodings = self.accept_compression_encodings;
                ...
                "/queue.Queue/Size" => {
                    ...
                    impl<T: Queue> tonic::server::UnaryService<super::SizeRequest> for SizeSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move { <T as Queue>::size(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
                    let accept_compression_encodings = self.accept_compression_encodings;
                ...
                "/queue.Queue/ReplicateData" => {
                    ...
                    impl<T: Queue> tonic::server::StreamingService<super::ReplicateDataRequest>
                        for ReplicateDataSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut =
                                async move { <T as Queue>::replicate_data(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
                    let accept_compression_encodings = self.accept_compression_encodings;
